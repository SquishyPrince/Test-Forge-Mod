...
public class CrushingBlock2 extends BlockContainer {

	protected CrushingBlock2(Material p_i45386_1_) {
		super(p_i45386_1_);
		setHardness(1F);
		setStepSound(Block.soundTypePiston);
		setBlockName("CrushingBlock2");
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new CrushingBlockTileEntity2();
	}
